...
<tr><td>Strength:</td><td>28</td></tr>
<tr><td>Agility:</td><td>20</td></tr>
<tr><td>Vitality:</td><td>25</td></tr>
<tr><td>Energy:</td><td>10</td></tr>
</table>
</div>
<div class="stats_overlay">
</div>
<div class="stats_overlay_buttons">
<table cellspacing="0"><tr><td id="sob1"><input class="input_name" type="text" id="cname" maxlength='12' /></td><td id="sob2"></td><td><a href="#" id="ok_button">OK</a></td><td id="sob3"></td><td><a href="#" id="cancel_button">Cancel</a></td></tr></table>
</div>
</div>
<?php
if(isset($ch1_name))
...
?>
<table id="character_selection3"><tr><td><button type="button" id="create_button">Create</button></td><td id="character_selection3_middle"></td><td><button type="button" id="select_button">Select</button></td><td><button type="button" id="delete_button">Delete</button></td></tr></table>
</div></td></tr><tr><td><div id="character_selection2">
<div id="js_output">Click "Create" to create a new character. You can create up to three characters. Name requirements: letters of the alphabet and numbers only, no spaces. Length: 3 to 12 symbols. Click on the character's avatar and then click "Select" or Delete"</div>
...
jAlert('Character: >> ' + char_number + ' << is active.', 'Message');
...
jConfirm('Delete this character?', 'Confirm deleting:', function(r) {deleting_confirmed(r, new_active_av);});
}
});
...
stats_data[0] = '<table class="stats_table"><tr><td>Strength:</td><td>28</td></tr><tr><td>Agility:</td><td>20</td></tr><tr><td>Vitality:</td><td>25</td></tr><tr><td>Energy:</td><td>10</td></tr></table>';
stats_data[1] = '<table class="stats_table"><tr><td>Strength:</td><td>18</td></tr><tr><td>Agility:</td><td>18</td></tr><tr><td>Vitality:</td><td>15</td></tr><tr><td>Energy:</td><td>30</td></tr></table>';
stats_data[2] = '<table class="stats_table"><tr><td>Strength:</td><td>22</td></tr><tr><td>Agility:</td><td>25</td></tr><tr><td>Vitality:</td><td>20</td></tr><tr><td>Energy:</td><td>15</td></tr></table>';
stats_data[3] = '<table class="stats_table"><tr><td>Strength:</td><td>21</td></tr><tr><td>Agility:</td><td>21</td></tr><tr><td>Vitality:</td><td>18</td></tr><tr><td>Energy:</td><td>23</td></tr></table>';
