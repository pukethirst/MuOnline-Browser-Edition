...
<link href="chaos_machine.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="jquery_rotate.js"></script>
</head>
<body>
...
<div id="cmachine_inventory"><div id="npc32_inventory_ani"></div><table cellspacing="1" class="cmachine_inventory">
...
<div id="cmachine_legend"><a href="#" onmouseover="overlib('<br/>Fruit Of Creation<br/>Cloak of Invisibility<br/><br/>',ADAPTIVE_WIDTH, 180,320,2)" onmouseout="nd()">Misturas disponiveis</a></div>

<div id="cmachine_goblin_underlay"></div>

<div id="cmachine_underlay"><img id="cmachine_under_img"  src="npc32/chaos_machine.gif"/></div>
<div id="cmachine_main"><img id="cmachine_img" src="npc32/chaos_machine.gif"/></div>
<div id="cmachine_overlay"><img src="npc32/chaos_machine1.png"/></div>

<table cellspacing="1" id="cmachine_goblin"><tr><td><img src="npc32/cmachine_goblin.gif"/></td><td><div id="npc32_output"></div></td><td id="cmachine_mix"><img id="mix_button"src="images/mix_button1.jpg"/></td></tr></table>

<table cellspacing="1" class="cmachine_table">
<tr><td id="title"><div id="title_ins">Chaos Machine</div></td></tr>
<tr><td id="chaos_machine">
...
var npc32_id =  'chaos_machine';
var npc32_kind =  'chaos_machine';
var npc32_error = '<?php echo $npc32_error; ?>';

if(npc32_error!=0)
$('#js_output').text('Remove items before navigating to another NPC');
...
var cmachine_angle=0;
var cmachine_under_angle=0;
$('#cmachine_img').rotate({duration:3000});
$('#cmachine_under_img').rotate({duration:6000});
...
$('#mix_button').mousedown(function(){
 ...
 if(document.getElementById('npc32_output').innerHTML!='Improper item combination' && document.getElementById('npc32_output').innerHTML!='Working...')
 {
 cmachine_angle +=90;
 cmachine_under_angle -=90;
 $('#cmachine_img').rotateAnimation(cmachine_angle);
 $('#cmachine_under_img').rotateAnimation(cmachine_under_angle);
 }
