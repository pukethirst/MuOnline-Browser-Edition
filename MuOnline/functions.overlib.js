...
description += 'Buy price: ' + item_price + '<br/>';
}
if(shop==2)
{
...
description += 'Sale Price: ' + item_price + '<br/>';
}
if(shop==6)
description += '[Click on item to pick up]<br/>';
...
var optional_desc = '';
 if(item_type == "9")
 optional_desc = 'Defense: ' + (item_effect + item_level);//shield defense is here to avoid coloring it blue for excellent items
 if(item_type == "A")
{
...
{
    if(item_sub_type == '9')
 optional_desc = '<a class=&quot;red&quot;>No Repair</a><br/>Increased Wizardry Damage + 10%<br/>Increased Damage + 10%<br/>Increased Speed + 10';
    else if(item_sub_type == '8')
 optional_desc = '<a class=&quot;red&quot;>No Repair</a><br/>I.D. of Kanturu Chief Scientist<br/>Allows access to the Refinery Tower';
 ...
 switch (item_type)
{
  ...
  case "6":
  case "7":
  effect_kind='Defense: ' + (item_effect + item_level*3 + Math.ceil(item_excellent/100)*30);
  break;
  case "8":
if(item_sub_type == '1')
  effect_kind='Defense: ' + (item_effect + item_level*3) + '<br/>Increase: ' + (12 + item_level*2) + ' % of damage<br/>Absorb: ' + (12 + item_level*2) + ' % of damage<br/>Increase speed';
else
  effect_kind='Defense: ' + (item_effect + item_level*2) + '<br/>Increase: ' + (25 + item_level*2) + ' % of damage<br/>Absorb: ' + (25 + item_level*2) + ' % of damage<br/>Increase speed';
  break;
  case "9":
  effect_kind='Defense Rate: ' + (item_effect*3 + item_level*3 + Math.ceil(item_excellent/100)*30);
  break;
  case "F":
...
bold_add_info = '<br/><a class=&quot;blue&quot;><b>Wizardry Damage ' + Math.floor((item_effect + item_level*3 + Math.ceil(item_excellent/100)*30)*5/6) + '% rise</b></a>';
...
if(item_luck!=0)
description += '<br/><a class=&quot;blue&quot;>Chance (Success of Jewel of Soul + 25%)<br/>Chance (Critical Damage Rate + 5%)</a>';
