...
<div id="map_name">Continent of MU</div>
<br>
<br><b>
<center><div style="padding-bottom:0px; border-bottom:0px dashed #3BC;">Lets get started!</div><br>
<div style="padding-bottom:0px; border-bottom:0px dashed #3BC;">1 - Buy Weapon <a href="shop.php?id=lorencia2">Click Here</a></link></div>
<div style="padding-bottom:0px; border-bottom:0px dashed #3BC;">2 - For your first fight try: Lorencia - Spot 1</div></center>
</div><b>
<div id="map_spot_div">
<div id="map_spot_pic"><img src="maps/map_spot.jpg" /></div>
<div id="enter_spot"><div id="enter_spot_button">Enter</div></div>
</div>
</td></tr></table>
</div>
</td></tr></table>
...
{
 $('#enter_spot').before('<div id="map_spot_chars">...</div><div id="map_spot_enc">Monsters possible to find:</div><div id="map_spot_enc_legend"></div>');
}
else
$('.enc_monster').remove();
